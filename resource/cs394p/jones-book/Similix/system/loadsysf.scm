...
(newline)
(display "Welcome to Similix 5.1")
(newline)
(display "Copyright (C) 1993,1994 Anders Bondorf")
(newline)
...
;----------------------------------------------------------------------------
; Temporary files used by Similix are named by computing
; (string-append **Similix-tmp-file** <number> **Similix-source-suffix**)
